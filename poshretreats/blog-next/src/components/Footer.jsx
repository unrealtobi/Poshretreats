...
import { FaTelegram, FaTiktok, FaWhatsapp, FaXTwitter } from "react-icons/fa6";
    ...
    <footer className="relative isolate w-full overflow-hidden bg-[url('/footerpic.jpeg')] bg-cover bg-center text-white">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center px-6 py-14 text-center sm:px-10 sm:py-16 md:px-12 md:py-20">
        ...
        <nav aria-label="Legal" className="mt-7 flex items-center text-sm text-gray-200">
          <a href="https://www.poshretreats.co.uk/termsandconditions" className="underline transition duration-300 hover:text-white">
            Terms &amp; Conditions
          </a>
          <span className="mx-2" aria-hidden="true">|</span>
          <a href="https://www.poshretreats.co.uk/privacy-policy" className="underline transition duration-300 hover:text-white">
            Privacy Policy
          </a>
        </nav>
